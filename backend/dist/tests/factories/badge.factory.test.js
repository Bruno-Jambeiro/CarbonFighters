...
const badge_factory_1 = require("../../src/factories/badge.factory");
const badge_model_1 = require("../../src/models/badge.model");
describe('BadgeFactory', () => {
    describe('createBadge - Factory Method', () => {
        describe('STREAK Badges', () => {
            it('should create a 7-day streak badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 7);
                expect(badge.type).toBe(badge_model_1.BadgeType.STREAK);
            ...
            it('should create a 30-day streak badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 30);
                expect(badge.type).toBe(badge_model_1.BadgeType.STREAK);
            ...
            it('should create a 100-day streak badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 100);
            ...
            it('should create a custom streak badge for non-standard days', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 15);
        ...
        describe('MILESTONE Badges', () => {
            it('should create a 10 actions milestone badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 10);
                expect(badge.type).toBe(badge_model_1.BadgeType.MILESTONE);
            ...
            it('should create a 100 actions milestone badge (Eco Rookie)', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 100);
                expect(badge.name).toBe('Eco Rookie');
                expect(badge.icon).toBe('🌱');
                expect(badge.points).toBe(100);
            });
            it('should create a 500 actions milestone badge (Eco Warrior)', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 500);
            ...
            it('should create a 1000 actions milestone badge (Eco Legend)', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 1000);
                expect(badge.name).toBe('Eco Legend');
                expect(badge.icon).toBe('👑');
                expect(badge.points).toBe(1000);
            });
            it('should create a custom milestone badge for non-standard counts', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 250);
        ...
        describe('SPECIAL Event Badges', () => {
            it('should create Earth Day 2025 special badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.SPECIAL, 1);
                expect(badge.type).toBe(badge_model_1.BadgeType.SPECIAL);
            ...
            it('should create Zero Waste Challenge special badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.SPECIAL, 2);
                expect(badge.name).toBe('Campeão Zero Waste');
                expect(badge.points).toBe(750);
            });
            it('should create Environment Week special badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.SPECIAL, 3);
            ...
            it('should create a generic special badge for unknown event IDs', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.SPECIAL, 99);
        ...
        describe('CATEGORY Badges', () => {
            it('should create Green Transport Master badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 1);
                expect(badge.type).toBe(badge_model_1.BadgeType.CATEGORY);
            ...
            it('should create Recycling King badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 2);
                expect(badge.name).toBe('Rei da Reciclagem');
                expect(badge.icon).toBe('♻️');
            });
            it('should create Water Guardian badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 3);
                expect(badge.name).toBe('Guardião da Água');
                expect(badge.icon).toBe('💧');
            });
            it('should create Energy Warrior badge', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 4);
                expect(badge.name).toBe('Guerreiro da Energia');
                expect(badge.icon).toBe('⚡');
            });
            it('should create a generic category badge for unknown categories', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 99);
        ...
        describe('Error Handling', () => {
            it('should throw error for unknown badge type', () => {
                expect(() => {
                    badge_factory_1.BadgeFactory.createBadge('INVALID_TYPE', 10);
                }).toThrow('Unknown badge type: INVALID_TYPE');
            });
            it('should throw error for negative requirement', () => {
                expect(() => {
                    badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, -5);
                }).toThrow('Badge requirement must be a positive number');
            });
            it('should accept zero as requirement', () => {
                const badge = badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 0);
    ...
    describe('Helper Methods', () => {
        describe('getAvailableBadgeTypes', () => {
            it('should return all badge types', () => {
                const types = badge_factory_1.BadgeFactory.getAvailableBadgeTypes();
                expect(types).toContain(badge_model_1.BadgeType.STREAK);
                expect(types).toContain(badge_model_1.BadgeType.MILESTONE);
                expect(types).toContain(badge_model_1.BadgeType.SPECIAL);
                expect(types).toContain(badge_model_1.BadgeType.CATEGORY);
                expect(types.length).toBe(4);
            });
        });
        describe('getExampleBadges', () => {
            it('should return array of example badges', () => {
                const examples = badge_factory_1.BadgeFactory.getExampleBadges();
    ...
    describe('Points Calculation Logic', () => {
        it('should calculate streak badge points as days * 10', () => {
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 5).points).toBe(50);
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 15).points).toBe(150);
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.STREAK, 50).points).toBe(500);
        });
        it('should set milestone badge points equal to action count', () => {
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 75).points).toBe(75);
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.MILESTONE, 200).points).toBe(200);
        });
        it('should set category badge points to 300', () => {
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 1).points).toBe(300);
            expect(badge_factory_1.BadgeFactory.createBadge(badge_model_1.BadgeType.CATEGORY, 5).points).toBe(300);
        });
    });
});
